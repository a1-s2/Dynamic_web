...
<html>
    ...
    <body background="back.jpg">
       <table width="100%" style="background-color:white;border-radius:30px;opacity:0.7">
        ...
        <table width="100%" width="60px" height="50px" style="background-color:black;border-radius:440px">
            <tr align="center">
                <td class="mytheme"><a href="ManagerMenu.jsp">Home</a></td>
                <td class="mytheme"><a href="ManagementPage.jsp">Management</a></td>
                <td class="mytheme"><a href="ManagerProductPage.jsp">View Product</a></td>
                <td class="mytheme"><a href="ManagerPasswordChange.jsp">Password Setting</a></td>
                <td class="mytheme"><a href="CommonLoginPage.jsp">Logout</a></td>
            </tr>
        </table>
        <form name="frm" action="ManagerPasswordCode.jsp" onSubmit="call()" method="get">
    ...
    <table align="center" width="100%" cellspacing="5" cellpading="1" style="background-color:lightblue;border-radius:30px;opacity:0.9;width:50%;height:40%" border="0">
        ...
        <tr align="center">
            <td><input type="text" name="uid" placeholder="enter name here" style="width:50%;height:40px;border-radius:30px;background-color:orange"></td>
            </tr>
        ...
        <tr align="center">
            <td><input type="text" name="oldPass" placeholder="enter name here" style="width:50%;height:40px;border-radius:30px;background-color:orange"></td>
            </tr>
        ...
        <tr align="center">
            <td><input type="text" name="newPass" placeholder="enter id here" style="width:50%;height:40px;border-radius:30px;background-color:orange"></td>
            </tr>
        ...
        <tr align="center">
            <td><input type="text" name="cNewPass" placeholder="enter id here" style="width:50%;height:40px;border-radius:30px;background-color:orange"></td>
            </tr>
